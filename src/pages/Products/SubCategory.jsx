...
const breadcrumbs = [{ id: 1, name: 'Sub Category', href: '#' }]
...
export default function SubCategory() {
    ...
    const { subcategoryName } = useParams(); // Get subcategoryName from URL params

    useEffect(() => {
        fetchCategories()
        fetchAllProducts(subcategoryName); // Pass subcategoryName to fetchAllProducts
    }, [subcategoryName]) // Refetch when subcategoryName changes
